...
import sri.web.{ ReactDOM, ReactNativeWeb }
...
object RelayWebApp extends JSApp {
  ...
  override def main(): Unit = {
    ...
    val rc = RelayRootContainer(StarWarsApp.container,
                                StarWarsAppHomeQuery(js.Array("empire", "rebels")),
                                renderLoading = () => div()("Loading .."))
