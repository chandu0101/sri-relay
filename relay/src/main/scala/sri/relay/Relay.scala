...
object Relay extends js.Object {
  ...
  def createContainer[P <: RelayComponentProps, S](component: RelayTypedConstructor[P, S],
                                                   spec: RelayContainerSpec): RelayContainer[P, S] = js.native

  def getQueries[P <: RelayComponentProps, S](component: RelayContainer[P, S],
                                              route: RelayQueryConfig): RelayQuerySet = js.native
