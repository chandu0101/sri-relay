...
@js.native
class GraphQLFieldNode(fieldName: String,
                       fields: Seq[GraphQLFieldNode] = ???,
                       fragments: Seq[js.Any] = ???,
                       calls: Seq[GraphQLCallvNode],
                       alias: String = ???,
                       condition: String = ???,
                       metadata: js.Object = ???)
    extends GraphQLNode {
...
//* @param {?array<GraphQLQueryFragment|RelayRouteFragment|RelayFragmentReference>} fragments
@js.native
class GraphQLQueryFragment(name: String,
                           tpe: String,
                           fields: Seq[GraphQLFieldNode] = ???,
                           fragments: Seq[js.Any],
                           metadata: js.Object = ???)
...
@js.native
class GraphQLQuery(rootCall: String,
                   value: js.Any,
                   fields: Seq[GraphQLFieldNode] = ???,
                   fragments: Seq[js.Any] = ???,
                   metadata: js.Object = ???,
...
@js.native
class GraphQLOperation(name: String,
                       responseType: String,
                       call: GraphQLCallvNode,
                       fields: Seq[GraphQLFieldNode] = ???,
                       fragments: Seq[js.Any] = ???,
                       metadata: js.Object = ???)
    extends GraphQLNode {
...
/**
  ...
  */
@js.native
class GraphQLMutation(name: String,
                      responseType: String,
                      call: GraphQLCallvNode,
                      fields: Seq[GraphQLFieldNode] = ???,
                      fragments: Seq[js.Any] = ???,
                      metadata: js.Object = ???)
    extends GraphQLOperation(name, responseType, call, fields, fragments, metadata) {
...
/**
  ...
  */
@js.native
class GraphQLSubscription(name: String,
                          responseType: String,
                          call: GraphQLCallvNode,
                          fields: Seq[GraphQLFieldNode] = ???,
                          fragments: Seq[js.Any] = ???,
