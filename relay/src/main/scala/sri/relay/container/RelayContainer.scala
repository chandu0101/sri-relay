...
import sri.relay.{ RelayComponent, RelayComponentProps }
...
trait RelayContainer[P <: RelayComponentProps, S] extends js.Object {
  ...
  /**
    ...
    */
  def setVariables(partialVariables: js.UndefOr[Variables] = js.undefined,
                   callback: js.UndefOr[ComponentReadyStateChangeCallback] = js.undefined): Unit = js.native
  ...
  /**
    ...
    */
  def forceFetch(partialVariables: js.UndefOr[Variables] = js.undefined,
                 callback: js.UndefOr[ComponentReadyStateChangeCallback] = js.undefined): Unit = js.native
