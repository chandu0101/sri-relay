...
object RelayElementFactory {
  ...
  /**
    ...
    * @return
    */
  def getRelayTypedConstructor[P <: RelayComponentProps, S](ctor: js.Dynamic,
                                                            clz: Class[_ <: ReactComponentJS[P, S]]) = {
    ctor.asInstanceOf[RelayTypedConstructor[P, S]]
  }

  def createRelayElement[P <: RelayComponentProps, S](container: RelayContainer[P, S], props: P) =
